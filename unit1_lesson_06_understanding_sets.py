...
def test_common():
    assert {10} == common(set(range(11)), set(range(10, 100)))
    assert set() == common (set(range(10)), set(range(10, 20)))
    assert set(range(5,10)) == common (set(range(10)), set(range(5, 15)))

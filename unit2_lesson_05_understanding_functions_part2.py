...
# kwargs is a var-keyword parameter that can be bound to a variable number of named keyword arguments
# that don't map to any other function parameter at runtime.
...
def simple_format(format1, *args):
    """
